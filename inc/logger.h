...
#ifdef _MSC_VER
#define LOGGER_UNUSED(arg) __noop
#else
...
#define LOGGER_LOG_ERROR(out_stream, tag, format_string, ...)   __noop
#define LOGGER_LOG_WARNING(out_stream, tag, format_string, ...) __noop
#define LOGGER_LOG_INFO(out_stream, tag, format_string, ...)    __noop
#define LOGGER_LOG_DEBUG(out_stream, tag, format_string, ...)   __noop
#define LOGGER_LOG_VERBOSE(out_stream, tag, format_string, ...) __noop
#else
